...
namespace ClinicVet.PetCare.UnitTests.Mock.Dtos.v1.CreatePetOwner;

public sealed class CreatePetOwnerDtoMock
{
    public static CreatePetOwnerDto GetDefaultInstance()
    {
        return new Faker<CreatePetOwnerDto>(Constants.Language)
